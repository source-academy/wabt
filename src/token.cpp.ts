...
export class Token {
    ...
    static EofToken(lexeme: string, line: number, col: number, indexInSource: number) {
...
export function IsTokenTypeBare(token_type: TokenType | undefined): boolean {
    if (typeof token_type === 'undefined')
        return false;
    return token_type === TokenType.Invalid
...
function IsTokenTypeString(token_type: TokenType | undefined): boolean {
    if (typeof token_type === 'undefined')
        return false;
    return token_type === TokenType.AlignEqNat
...
export function IsTokenTypeOpcode(token_type: TokenType | undefined): boolean {
    if (typeof token_type === 'undefined')
        return false;
    return token_type === TokenType.AtomicFence
...
export function IsTokenTypeLiteral(token_type: TokenType | undefined): boolean {
    if (typeof token_type === 'undefined')
        return false;
    return token_type === TokenType.Float
...
export function IsTokenTypeRefKind(token_type: TokenType | undefined): boolean {
    if (typeof token_type === 'undefined')
        return false;
    return token_type === TokenType.Func
